...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Hp\PycharmProjects\Flight Reservation API'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Hp\PycharmProjects\Flight Reservation API\Scripts\deactivate.nu'
